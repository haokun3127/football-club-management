...
- 页面实现 `pages/coach/test-tasks` 按在线节点 `93:1002` 复原软粉 88px 顶栏、菜单胶囊避让、“新增”文字、32px 筛选、12px/16px 任务卡、4px 进度轨道、全卡右箭头以及 56px 悬浮新增按钮。
- 标题、日期、状态、进度和录入可用性继续全部来自 `getCoachAssessmentTasks()`。未开始任务轨道使用画板的灰色；其余真实状态继续走已有的状态样式与进入守卫。
