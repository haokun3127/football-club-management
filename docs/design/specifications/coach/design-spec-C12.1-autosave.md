...
- 在线基准为 `zZ6wKyOHKcO4UYXDd9jGwv / 93:1061`；此状态只代表设备本机已有的有效评分草稿，并不新增或暗示服务端自动保存。
- 遮罩显示期间，顶栏的展示标题切换为画板文案“成绩录入”；点击“继续录入”后恢复 C12 的“项目评分录入”。该标题是前端 view model，不影响真实活动、模板、成绩或草稿键。
