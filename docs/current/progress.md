...
- 受控刷新现在会严格按 `club_id + cq-talent-secure-test 槽位 ID 前缀 + 对应球队` 限定范围：已结束活动改为完成、未来活动维持待进行；历史参与人的待确认/邀请收口为已到场，请假申请收口为已批准请假；关联比赛状态同步。任何普通俱乐部数据、其他球队或其他 ID 命名空间均不触碰。
